...
$req = ('SELECT * FROM recette WHERE recette_type = "PLAT" AND recette_id = 11');
$requete = $bdd->query($req);
$recettes = $requete->fetchAll();

$req2 = ('SELECT * FROM recette WHERE recette_type = "PLAT" AND recette_id = 12');
$requete2 = $bdd->query($req2);
$recettes2 = $requete2->fetchAll();

$req3 = ('SELECT * FROM recette WHERE recette_type = "PLAT" AND recette_id = 13');
$requete3 = $bdd->query($req3);
$recettes3 = $requete3->fetchAll();

$req4 = ('SELECT * FROM recette WHERE recette_type = "PLAT" AND recette_id = 14');
$requete4 = $bdd->query($req4);
$recettes4 = $requete4->fetchAll();

$req5 = ('SELECT * FROM recette WHERE recette_type = "PLAT" AND recette_id = 15');
$requete5 = $bdd->query($req5);
$recettes5 = $requete5->fetchAll();

$req6 = ('SELECT * FROM recette WHERE recette_type = "PLAT" AND recette_id = 16');
$requete6 = $bdd->query($req6);
$recettes6 = $requete6->fetchAll();

$req7 = ('SELECT * FROM recette WHERE recette_type = "PLAT" AND recette_id = 17');
$requete7 = $bdd->query($req7);
$recettes7 = $requete7->fetchAll();

$req8 = ('SELECT * FROM recette WHERE recette_type = "PLAT" AND recette_id = 18');
$requete8 = $bdd->query($req8);
$recettes8 = $requete8->fetchAll();

$req9 = ('SELECT * FROM recette WHERE recette_type = "PLAT" AND recette_id = 19');
$requete9 = $bdd->query($req9);
$recettes9 = $requete9->fetchAll();

$req10 = ('SELECT * FROM recette WHERE recette_type = "PLAT" AND recette_id = 20');
        ...
        <div class="produit-container">
            <div class="produit-carte">
                <div class="produit-image">
                    ...
                    <img src="../img/Contenu/tagliatelle.jpg" class="produit-thumb" alt="">
                ...
                <div class="popup">
                    ...
                    <div class="infos">
                        <div class="infos-titre">
                            ...
                            <img src="../img/Contenu/tagliatelle.jpg" class="infos-img" alt="">
                        </div>
                        <div class="prepa">
            ...
            <div class="produit-carte">
                <div class="produit-image">
                    ...
                    <img src="../img/Contenu/tartare.jpg" class="produit-thumb" alt="">
                ...
                <div class="popup">
                    ...
                    <div class="infos">
                        <div class="infos-titre">
                            ...
                            <img src="../img/Contenu/tartare.jpg" class="infos-img" alt="">
                        </div>
                        <div class="prepa">
            ...
            <div class="produit-carte">
                <div class="produit-image">
                    ...
                    <img src="../img/Contenu/tortellinis.jpg" class="produit-thumb" alt="">
                    <button class="carte-btn">Ajouter aux favoris</button>
                </div>
                <div class="produit-info">
                ...
                <div class="popup">
                    ...
                    <div class="infos">
                        <div class="infos-titre">
                            ...
                            <img src="../img/Contenu/tortellinis.jpg" class="infos-img" alt="">
                        </div>
                        <div class="prepa">
            ...
            <div class="produit-carte">
                <div class="produit-image">
                    ...
                    <img src="../img/Contenu/entrecote.jpg" class="produit-thumb" alt="">
                    <button class="carte-btn">Ajouter aux favoris</button>
                </div>
                <div class="produit-info">
                ...
                <div class="popup">
                    ...
                    <div class="infos">
                        <div class="infos-titre">
                            ...
                            <img src="../img/Contenu/entrecote.jpg" class="infos-img" alt="">
                        </div>
                        <div class="prepa">
            ...
            <div class="produit-carte">
                <div class="produit-image">
                    ...
                    <img src="../img/Contenu/poulet-a-la-sauge.png" class="produit-thumb" alt="">
                    <button class="carte-btn">Ajouter aux favoris</button>
                </div>
                <div class="produit-info">
                ...
                <div class="popup">
                    ...
                    <div class="infos">
                        <div class="infos-titre">
                            ...
                            <img src="../img/Contenu/poulet-a-la-sauge.png" class="infos-img" alt="">
                        </div>
                        <div class="prepa">
            ...
            <div class="produit-carte">
                <div class="produit-image">
                    ...
                    <img src="../img/Contenu/porc.jpeg" class="produit-thumb" alt="">
                    <button class="carte-btn">Ajouter aux favoris</button>
                </div>
                <div class="produit-info">
                ...
                <div class="popup">
                    ...
                    <div class="infos">
                        <div class="infos-titre">
                            ...
                            <img src="../img/Contenu/porc.jpeg" class="infos-img" alt="">
                        </div>
                        <div class="prepa">
            ...
            <div class="produit-carte">
                <div class="produit-image">
                    ...
                    <img src="../img/Contenu/citronelle.jpg" class="produit-thumb" alt="">
                    <button class="carte-btn">Ajouter aux favoris</button>
                </div>
                <div class="produit-info">
                ...
                <div class="popup">
                    ...
                    <div class="infos">
                        <div class="infos-titre">
                            ...
                            <img src="../img/Contenu/citronelle.jpg" class="infos-img" alt="">
                        </div>
                        <div class="prepa">
            ...
            <div class="produit-carte">
                <div class="produit-image">
                    ...
                    <img src="../img/Contenu/semoule.jpg" class="produit-thumb" alt="">
                    <button class="carte-btn">Ajouter aux favoris</button>
                </div>
                <div class="produit-info">
                ...
                <div class="popup">
                    ...
                    <div class="infos">
                        <div class="infos-titre">
                            ...
                            <img src="../img/Contenu/semoule.jpg" class="infos-img" alt="">
                        </div>
                        <div class="prepa">
            ...
            <div class="produit-carte">
                <div class="produit-image">
                    ...
                    <img src="../img/Contenu/saumonasperges.jpeg" class="produit-thumb" alt="">
                    <button class="carte-btn">Ajouter aux favoris</button>
                </div>
                <div class="produit-info">
                ...
                <div class="popup">
                    ...
                    <div class="infos">
                        <div class="infos-titre">
                            ...
                            <img src="../img/Contenu/saumonasperges.jpeg" class="infos-img" alt="">
                        </div>
                        <div class="prepa">
            ...
            <div class="produit-carte">
                <div class="produit-image">
                    ...
                    <img src="../img/Contenu/lieunoir.jpg" class="produit-thumb" alt="">
                    <button class="carte-btn">Ajouter aux favoris</button>
                </div>
                <div class="produit-info">
                ...
                <div class="popup">
                    ...
                    <div class="infos">
                        <div class="infos-titre">
                            ...
                            <img src="../img/Contenu/lieunoir.jpg" class="infos-img" alt="">
                        </div>
                        <div class="prepa">
